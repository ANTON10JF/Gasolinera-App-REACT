...
export default function Product() {
    ...
    return (
        <>
            <Heading textAlign="center" size="lg" marginBottom={10}>Selecciona el producto</Heading>
            ...
            <Box marginTop="40px">
                ...
                >
                    <Button leftIcon={<ArrowBackIcon />} colorScheme="teal" variant="outline">Volver al surtidor</Button>
                </Stack>
            </Box>
        </>
    )
